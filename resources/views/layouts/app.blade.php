...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar navbar-default" style="background-color:black">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            <li><a class="nav-link" href="{{ route('home') }}">MyEvents</a></li>
                        @endauth
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  @auth
                                  <a  class="dropdown-item" href="{{ route('events.create') }}" title="see your events">Create Events</a>
                                  @endauth
                                <a class="dropdown-item" href="/events?popular=1">popular</a>
                                <a class="dropdown-item" href="/events?futureevents=1">Upcoming events</a>
